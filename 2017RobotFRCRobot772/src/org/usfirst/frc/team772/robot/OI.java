...
import org.usfirst.frc.team772.robot.commands.group.AutonomousTestCommand;
import org.usfirst.frc.team772.robot.commands.group.VisionShootCloseCommand;
import org.usfirst.frc.team772.robot.commands.group.VisionShootFarCommand;
...
public class OI {
	...
	public OI(){
		...
		j1button5.whileHeld(new ShootCommand(true, 0.85));//72
		j1button6.whileHeld(new ShootCommand(true, 1));//72
//		j1button7.whenPressed(new AutoDriveCommand(-7));
...
//		j1button8.whileHeld(new OpenBoilerSocketCommand());
		...
		j2button4.whileHeld(new VisionShootFarCommand());
